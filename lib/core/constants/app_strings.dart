...
class AppStrings {
  // Start Day Screen
  static const String startDayTitle = 'Start Day Session';
  static const String instructionText =
      'Search for the products in your stock that you are willing to sell today and enter the start quantity for each.';
